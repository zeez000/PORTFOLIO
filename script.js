...
function paintBase(){const sky=context.createLinearGradient(0,0,width,height);sky.addColorStop(0,"#060817");sky.addColorStop(.48,"#0d1232");sky.addColorStop(1,"#160f32");context.fillStyle=sky;context.fillRect(0,0,width,height);const aurora=context.createRadialGradient(width*(.22+pointer.x*.18),height*(.16+pointer.y*.08),0,width*.25,height*.18,width*.72);aurora.addColorStop(0,"rgba(86,238,255,.16)");aurora.addColorStop(.42,"rgba(83,129,255,.07)");aurora.addColorStop(1,"rgba(83,129,255,0)");context.fillStyle=aurora;context.fillRect(0,0,width,height)}
